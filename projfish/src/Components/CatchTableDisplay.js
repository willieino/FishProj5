    ...
    return (
      ...
      <ReactTable
       ...
       columns={[
        ...
        { Header: "Pressure", accessor: "Pressure", Cell: this.renderEditable},
        { Header: "Barometer", accessor: "Barometer", Cell: this.renderEditable},
        { Header: "Water Temp", accessor: "WaterTemp", Cell: this.renderEditable},
        { Header: "Water Depth", accessor: "WaterDepth", Cell: this.renderEditable, width: 100},
        { Header: "Water Ph", accessor: "WaterPh", Cell: this.renderEditable},
